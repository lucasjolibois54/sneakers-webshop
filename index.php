...
<header>
    ...
    <li><a href="cart.php#">Cart</a></li>
      ...
      <h1 class="text-3xl ml-8 mt-10 mb-10 md:hidden font-bold mb-5">Discover limited <br/>sneakers without <br/>limitation</h1>
  ...
  <div class="md:block hidden h-screen">
    ...
    <h1 class="hidden font-bold mb-5">// Featured Products</h1>
  ...
  <a href="all_products.php" class="border-2 rounded-full px-3 py-2 border border-black text-lg">EXPLORE NOW</a>
    ...
    <div class=" max-w-7xl md:ml-28 pl-8 mr-8 mb-20">
